...
try {
  ...
  await database.query('CREATE TABLE IF NOT EXISTS previewhost_demo_notes (id uuid PRIMARY KEY, text text NOT NULL CHECK (char_length(text) BETWEEN 1 AND 160), revision text NOT NULL, created_at timestamptz NOT NULL DEFAULT now())');
