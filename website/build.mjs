...
function pageHead(page) {
  ...
  const imageAlt = 'Previewhost. Local previews for full-stack apps. Run and manage multiple isolated previews side by side, with your frontend, API, databases, and services together. Open source · CLI · MCP. previewhost.app';
